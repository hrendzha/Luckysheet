export default {
    ...
    GET_AIRTABLE_DATA: {
      ...
      p: [
        ...
        },
        {
          name: "sort_column",
          detail:
            "The index of the column in current AirTable view containing the values by which to sort.",
        },
        {
          name: "is_ascending",
          detail:
  ...
  findAndReplace: {
    ...
    locationExample: "Місцезнаходження",
    lessTwoRowTip: "Будь ласка, виберіть принаймні два рядки",
    lessTwoColumnTip: "Виберіть принаймні два стовпці",

    findTextbox: "Знайти вміст",
    replaceTextbox: "Замінити вміст",

    regexTextbox: "Регулярний вираз",
    wholeTextbox: "Ціле слово",
    distinguishTextbox: "Чутливий до регістру",

    allReplaceBtn: "Замінити все",
    replaceBtn: "Замінити",
    allFindBtn: "Знайти все",
    findBtn: "Знайти далі",

    noFindTip: "Вміст не знайдено",
    modeTip: "Ця операція недоступна в цьому режимі",

    searchTargetSheet: "Аркуш",
    searchTargetCell: "Клітинка",
    searchTargetValue: "Значення",

    searchInputTip: "Будь ласка, введіть пошуковий вміст",

    noReplceTip: "Немає що замінити",
    noMatchTip: "Збігів не знайдено",

    successTip: "${xlength} випадків замінено",
    ...
    locationError: "Помилка",
    locationNull: "Null",
    locationCondition: "Conditional format",
    locationRowSpan: "Row span",
    locationColumnSpan: "Column span",

    locationTiplessTwoRow: "Будь ласка, виберіть принаймні два рядки",
    locationTiplessTwoColumn: "Виберіть принаймні два стовпці",
    locationTipNotFindCell: "Клітинку не знайдено",
  },
  sheetconfig: {
    delete: "Delete",
    copy: "Copy",
  ...
  exportXlsx: {
    notice: "Будь ласка, налаштуйте плагін експорту",
    serverError: "server is under maintenance",
    title: "Експорт XLSX",
    range: "Діапазон",
    currentSheet: "Поточний аркуш",
    allSheets: "Всі аркуші",
